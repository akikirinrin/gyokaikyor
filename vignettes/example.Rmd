...
fpath <- "/home/rstudio/exceldir/202003/マアジ/2 加入量指数の計算/✅20200325漁海況　マアジ加入量.xlsx"

dat <- parse_index(fpath, 2019, "geomean")

foo <- dat %>% dplyr::filter(Year >= 2006) %>%
